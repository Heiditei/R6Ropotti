...
int main()
{
     ...
     for(;;)
    {
        ...
        // aja oikealle, kun l3 osuu mustalle
        ...
        //aja oikealle, kun l3 ja l1 osuu mustalle
        ...
        // aja oikealle, kun l3, l1 ja r1 osuu mustalle
        if (dig.l3 == 0 && dig.l1 == 0 && dig.r1 == 0 && dig.r3 == 1) {
          if ((ref.r1 > 15000) && (ref.l1 < 9000) && (ref.r3 < 9000) && (ref.l3 < 9000)) {
            motor_turn (nopeus,0, 0); 
        }//l3 = valk, l1 = valk, r1 = must, r3 =must
        else if ((ref.r1 > 15000) && (ref.r3 > 15000) && (ref.l1 < 9000) && (ref.l3 < 9000)) {
        ...
        //aja vasemmalle kun r3, r1 ja l1 osuu  mustalle
        ...
        //aja vasemmalle kun r1 ja r3 on mustalla
        ...
        //aja vasemmalle kun r3 on mustalla
        if (dig.l3 == 1 && dig.l1 == 1 && dig.r1 == 1 && dig.r3 == 0) {
